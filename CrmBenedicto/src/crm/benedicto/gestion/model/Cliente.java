...
public class Cliente {
    ...
    public Cliente(int codigo, String nombres, String apellidopaterno, String apellidomaterno, String email, int dni, int telefono, int celular, Date fechadecontacto) {
        this.codigo = codigo;
